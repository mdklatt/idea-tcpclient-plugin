...
public class TcpRequestSendRequestImpl extends ASTWrapperPsiElement implements TcpRequestSendRequest {

  public TcpRequestSendRequestImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TcpRequestVisitor visitor) {
    visitor.visitSendRequest(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getQuoted() {
    return findNotNullChildByType(QUOTED);
  }
